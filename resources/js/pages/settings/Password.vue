...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall :title="$t('update_password')" :description="$t('ensure_your_account_is_using_a_long')" />

                <Form v-bind="update.form()" :options="{
                    preserveScroll: true,
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="password" ref="passwordInput" name="password" type="password"
                            class="mt-1 block w-full" autocomplete="new-password" :placeholder="$t('new_password')" />
