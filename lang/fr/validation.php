...
return [
    ...
    | comme les règles de taille. N'hésitez pas à ajuster ces messages selon vos besoins.
    |
    */
    ...
    'rate_must_be_greater' => 'Le taux doit être > 0,700.',
    'please_provide_a_valid_token_name' => 'Veuillez fournir un nom de jeton valide.',
    'this_token_already_exists_for_your_account' => 'Ce jeton existe déjà pour votre compte.',
    'the_token_must_not_be_longer_than_32_characters' => 'Le jeton ne doit pas dépasser 32 caractères.',
    'please_provide_a_valid_value_for_decimals' => 'Veuillez fournir une valeur valide pour les décimales.',
    'one_of_0_1_2_3_4_5_6' => 'Une valeur parmi 0,1,2,3,4,5,6.',

    'the_policy_ID_must_be_56hex_chars' => 'L’ID de politique doit contenir 56 caractères hexadécimaux.',
    'the_policy_ID_contains_invalid_characters' => 'L’ID de politique contient des caractères invalides.',
    'the_policy_ID_does_not_exist' => 'L’ID de politique n’existe pas.',
    'the_address_must_start_with_addr1' => 'L’adresse doit commencer par addr1.',
    'the_address_contains_invalid_characters' => 'L’adresse contient des caractères invalides.',

    'not_implemented_yet' => 'Pas encore implémenté',
    'number_must_be_less_than' => 'Le numéro doit être inférieur ou égal à ',
    'babel_fee_not_updated' => 'Le frais Babel n’a pas été mis à jour.',
    'babel_fee_updated_successfully' => 'Le frais Babel a été mis à jour avec succès.',
    'babel_fee_deleted_successfully' => 'Le frais Babel a été supprimé avec succès.',
    'babel_fee_not_deleted' => 'Le frais Babel n’a pas été supprimé.',
    'contact_updated_successfully' => 'Le contact a été mis à jour avec succès.',
    'contact_not_updated' => 'Le contact n’a pas été mis à jour.',
    'contact_deleted_successfully' => 'Le contact a été supprimé avec succès.',
    'contact_not_deleted' => 'Le contact n’a pas été supprimé.',
    'payment_request_not_updated' => 'La demande de paiement n’a pas été mise à jour.',
    'payment_request_updated_successfully' => 'La demande de paiement a été mise à jour avec succès.',
    'payment_request_not_deleted' => 'La demande de paiement n’a pas été supprimée.',
    'payment_request_deleted_successfully' => 'La demande de paiement a été supprimée avec succès.',
    'payment_request_not_created' => 'La demande de paiement n’a pas été créée.',
    'payment_request_created_successfully' => 'La demande de paiement a été créée avec succès.',

    'token_not_present' => 'Le jeton n’est pas présent dans le portefeuille.',

    'inbound_cost_updated_successfully' => 'Le coût a été mis à jour avec succès.',
    'inbound_cost_not_updated' => 'Le coût n’a pas été mis à jour.',
    'token_successfully_created_as_inbound_cost' => 'Le jeton a été créé avec succès comme coût.',
    'token_not_created_as_inbound_cost' => 'Le jeton n’a pas été créé comme coût.',
    'inbound_cost_not_deleted' => 'Le coût n’a pas été supprimé.',
    'inbound_cost_deleted_successfully' => 'Le coût a été supprimé avec succès.',
    'this_location_already_exists_for_your_account' => 'Cette localisation existe déjà pour votre compte.',
    ...
    | en utilisant la convention "attribut.règle". Cela permet de définir rapidement
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer nos noms d’attributs
    | par quelque chose de plus compréhensible, comme "Adresse e-mail" au lieu de "email".
    |
    */
